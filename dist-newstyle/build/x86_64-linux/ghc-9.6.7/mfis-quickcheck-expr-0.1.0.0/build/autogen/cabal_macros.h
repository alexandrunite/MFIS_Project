...
/* package mfis-quickcheck-expr-0.1.0.0 */
#ifndef VERSION_mfis_quickcheck_expr
#define VERSION_mfis_quickcheck_expr "0.1.0.0"
#endif /* VERSION_mfis_quickcheck_expr */
#ifndef MIN_VERSION_mfis_quickcheck_expr
#define MIN_VERSION_mfis_quickcheck_expr(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mfis_quickcheck_expr */
...
#define CURRENT_PACKAGE_KEY "mfis-quickcheck-expr-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "mfis-quickcheck-expr-0.1.0.0-inplace"
